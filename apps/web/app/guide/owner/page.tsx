...
export default function OwnerManagerGuidePage() {
  return (
    <div className="min-h-screen">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "Article", "headline": "Owner & Manager Guide", "description": "Everything you need to get your FFXIV roleplay venue running — setup, plugin install, staff management, events, payroll and more.", "url": "https://xivvenuemanager.com/guide/owner", "publisher": { "@type": "Organization", "name": "XIV Venue Manager", "url": "https://xivvenuemanager.com" } }) }} />
      {/* Guide hero */}
