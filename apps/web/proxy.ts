...
const PUBLIC_PREFIXES = ["/.well-known/", "/guide/", "/invite/", "/venues/", "/following", "/discover/", "/api/invites/", "/api/mobile/", "/api/shout-crafter/", "/api/feedback", "/api/stats", "/api/public/"]
...
export const config = {
  matcher: [
    "/((?!api/auth|api/cron|api/plugin|api/discord|api/bot|api/stats|api/homepage|api/diag|_next/static|_next/image|favicon.ico|.*\\.png|.*\\.jpg|.*\\.svg|.*\\.webp).*)",
  ],
}
