...
import { rankForXp, nextRankThreshold, RANK_THRESHOLDS, levelFromXp, loyaltyTier, GC_LABELS, GC_EMOJI, type GrandCompany } from '../../utils/xp.js';
...
export default {
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(fields)
      .setFooter({ text: `Member since ${joinedAt.toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}` });
